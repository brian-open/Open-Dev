...
register_nav_menus( 
	array(
		'main'	=>	__( 'main', 'voxxify' ),
        'home'	=>	__( 'home', 'voxxify' ),
        'nav-column-1'	=>	__( 'nav-column-1', 'voxxify' ),
        'nav-column-2'	=>	__( 'nav-column-2', 'voxxify' ),
        'social'	=>	__( 'social', 'voxxify' ),
...
function theme_scripts()  { 
    ...
    // Match Height
	wp_enqueue_script( 'match-height-js', get_stylesheet_directory_uri() . '/src/js/jquery.matchHeight.js', array(), null, true );  
